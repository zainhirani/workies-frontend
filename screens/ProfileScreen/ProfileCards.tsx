...
const ProfileCard = ({title}:ProfileCardProps) => {
  ...
  return (
    <Grid onClick={()=>router.push("/profile/details")} item xs={5} sx={{cursor:"pointer",display:"flex",height:"200px",justifyContent:"center",alignItems:"center",borderRadius:2,"&:hover":{
